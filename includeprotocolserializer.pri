...
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/lib/libprotocol-serializerd.a
else:msvc:win32:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/lib/protocol-serializer.lib
else:msvc:win32:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/lib/protocol-serializerd.lib
